...
use roswell_ros2_compat::diagnostics::{DiagnosticLevel, DiagnosticStatus, Diagnostics, KeyValue};
use roswell_ros2_compat::lifecycle::LifecycleServices;
use roswell_ros2_compat::log::{LogSite, Rosout, Severity};
use roswell_ros2_compat::msgs;
use roswell_ros2_compat::node::Node;
use roswell_ros2_compat::parameters::{ParameterDescriptor, ParameterType, ParameterValue};
use roswell_ros2_compat::tf::{StaticTfBroadcaster, TfBroadcaster, Transform};
use roswell_ros2_compat::time::{ClockMsg, Time};
use roswell_ros2_compat::transport::{MsgPublisher, Qos};
use roswell_ros2_compat::type_description::{TypeDescriptionRegistry, TypeDescriptionService};
...
fn main() {
    ...
    parameters.declare(
        ...
        ParameterValue::String("roswell".into()),
    );
    parameters.declare(

...
use roswell_ros2_compat::msgs::{geometry_msgs__Twist, geometry_msgs__Vector3, turtlesim__Pose};
use roswell_ros2_compat::transport::{Dds, MsgPublisher, MsgSubscriber, Qos, Transport};
    ...
    let result = loop {
        ...
        term.draw(|f| {
            let block = Block::default()
                .borders(Borders::ALL)
                .title(" roswell turtle teleop (RTPS + our CDR) ");

//! Machine-checked pure cores for roscmp's real-time hot paths.
//!
//! Each function here is the **production** implementation used by `roscmp`
//! (`dynamic::round_up`, the CDR padding formula) and `roscmp-dds`

/*
 * roswell.h — C-ABI for the roswell runtime.
 *
 * Speak ROS 2 (RTPS/DDS) from C or ctypes with no ROS installation, no codegen:
...
/*
 * An opaque, generation-counted handle to any roswell object (context, type,
...
/* The ROS 2 DDS type name. Owned string (free with rcm_string_free). NULL on error. */
